...
curl --request GET \
 ...
 -s  --header 'content-type: application/json' \
  ...
  --data '{"size": 10000,"_source": ["spanID","operationName","duration","startTimeMillis"],"query": {"bool": {"filter": [{"term": {"process.serviceName": "route"}},{"nested": {"path": "tags","query": {"bool": {"must": [{"term": {"tags.key": "span.kind"}},{"term": {"tags.value": "server"}}]}}}},{"range": {"startTimeMillis": {"gte": "now-20m","lte": "now","format": "epoch_millis"}}}]}}}'  \
